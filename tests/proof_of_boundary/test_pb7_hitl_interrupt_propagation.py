...
#
# Two test cases (coe/review-criteria CLAUDE.md §8-2 PB-7):
#
...
# References:
#   CLAUDE.md §8-2 PB-7
#   CLAUDE.md §2-4 HITL Compliance (D6 pattern, hitl_allowed guard)
#   hitl_allowed guard requirement (criterion #12)
